...
public class Entity_Settings {
	...
	public static final float BUILDING_ENERGY[] = { 0.2f, 0.4f, 0.8f };
	public static final float BUILDING_LIFE[] = { 180f, 220f, 280f };
	...
	public static final float repareRateIncrese = 0.08f;
